...
%>
        ...
        <tr>
            ...
            <td>
                <a href="/Repertoar/admin/izmenifilm.jsp?id=<%=rs.getInt("id")%>" class="blue-text"><i class="fa fa-edit"></i>
                
                </a> <a href="/Repertoar/IzbrisiFilm?id=<%=rs.getInt("id")%>" class="red-text"><i class="fa fa-times"></i></a>
            </td>
        </tr>
<%
}
