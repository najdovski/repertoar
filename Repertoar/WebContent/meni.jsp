...
%>
<div class="float-left"> <a href="/admin" class="btn btn-unique"><span class="mr-2"><i class="fas fa-user"></i></span>Админ панел</a></div>
<%
}else{
	%>
...
<nav class="navbar navbar-expand-md navbar-dark svetlo-sina my-3">
        <div class="container">
            <a class="navbar-brand" href="index.jsp"><img class="img-fluid logo" src="sliki/logo.png"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a id="pocetna" class="nav-link active" href="index.jsp">Почетна</a>
                    </li>
                    <li class="nav-item">
