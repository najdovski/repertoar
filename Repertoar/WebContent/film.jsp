...
<div class="my-4">
<a href="https://www.facebook.com/sharer/sharer.php?u=https://repertoar.herokuapp.com/film.jsp?id=<%=film_id%>" target="_blank">
...
<div class="my-4">
<a href="https://twitter.com/home?status=https://repertoar.herokuapp.com/film.jsp?id=<%=film_id%>" target="_blank">
...
<script>
$(function(){
	var URL = 'https://www.omdbapi.com/?i=<%=film.getString("imdb")%>&apikey=c7092a72';
